    ...
    return (
        <section>
            ...
            <div className="menubar">
                <Link to="/" className={location.pathname === '/' ? 'box-menu active' : 'box-menu'} onClick={() => handleMenuClick('/')}>
                    <span className="iconMenuSpan"><HiOutlineHome /></span><span>Home</span>
                </Link>
                <Link to="#" className={location.pathname === '/chats' ? 'box-menu active' : 'box-menu'} onClick={() => handleMenuClick('/chats')}>
                    <span className="iconMenuSpan"><IoChatbubbleEllipsesOutline /></span><span>Chat</span>
                </Link>
                <Link to="/order" className={location.pathname === '/order' ? 'box-menu active' : 'box-menu'} onClick={() => handleMenuClick('/order')}>
                    <span className="iconMenuSpan"><BsClipboardCheck /></span><span>Order</span>
                </Link>
                <Link to="/cart" className={location.pathname === '/cart' ? 'box-menu active' : 'box-menu'} onClick={() => handleMenuClick('/cart')}>
                    <span className="iconMenuSpan"><BsCart3 /></span><span>Cart</span>
                </Link>
                <Link to="/contact" className={location.pathname === '/contact' ? 'box-menu active' : 'box-menu'} onClick={() => handleMenuClick('/contact')}>
